...
function SelectServices({ auth }) {
    ...
    console.log("🚀 ~ file: index.js ~ line 32 ~ SelectServices ~ products", products)
                        ...
                        <div className="row gx-0">
                            ...
                            <div className="col-12 col-sm-9 col-md-9 col-xxl-10">
                                <div className="details">
                                    <p>
                                        Please note: customer privacy is our top piority, these informations will be kept in secret.
                                    ...
                                    <div className="mt-5">
                                        {products && products.map((product) =>
                                            ...
                                            <div className="form-check service" key={product.id}>
                                                <input className="form-check-input" type="checkbox" value="" id={`${product.id}-check`} />
                                                <label className="form-check-label" htmlFor={`${product.id}-check`}>
                                                    {product.name}
                                                </label>
