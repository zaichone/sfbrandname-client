...
function UploadFileSerialNumber({ taskId, clientId, setImageSerialNumber, images, setImages, imageFront, imageFace, imageCaseEngravings, imageSerialNumber, imageCrown, imageClasp, imageAdditionalImage }) {
