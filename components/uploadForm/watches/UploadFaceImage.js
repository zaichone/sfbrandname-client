...
function UploadFaceImage({taskId, clientId , setImageFace,  images, setImages, imageFront, imageFace, imageCaseEngravings, imageSerialNumber, imageCrown, imageClasp, imageAdditionalImage}) {
    ...
    return (
        ...
        >
           ...
           <input style={{display:"none"}} type="file" onChange={uploadFileFace} id="filesFace" name="filesFace[]" multiple />
        </SymmetricalDiv>
    </div>
    )
}
