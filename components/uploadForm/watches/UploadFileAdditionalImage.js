...
function UploadFileAdditionalImage({ taskId, clientId, setImageAdditionalImage, images, setImages, imageFront, imageFace, imageCaseEngravings, imageSerialNumber, imageCrown, imageClasp, imageAdditionalImage }) {
