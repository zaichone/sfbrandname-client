...
function UploadFileCrown({ taskId, clientId, setImageCrown, images, setImages, imageFront, imageFace, imageCaseEngravings, imageSerialNumber, imageCrown, imageClasp, imageAdditionalImage }) {
    ...
    return (
        <div className="col-4 text-center mt-4">
            ...
            >
                ...
                <input style={{ display: "none" }} type="file" onChange={uploadFileCrown} id="filesCrown" name="filesCrown[]" multiple />
            </SymmetricalDiv>
        </div>
    )
}
