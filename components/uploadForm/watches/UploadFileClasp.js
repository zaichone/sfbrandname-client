...
function UploadFileClasp({ taskId, clientId, setImageClasp, images, setImages, imageFront, imageFace, imageCaseEngravings, imageSerialNumber, imageCrown, imageClasp, imageAdditionalImage }) {
    ...
    return (
        <div className="col-4 text-center mt-4">
            ...
            >
                ...
                <input style={{ display: "none" }} type="file" onChange={uploadFileClasp} id="filesClasp" name="filesAdditionalImage[]" multiple />
            </SymmetricalDiv>
        </div>
    )
}
