...
function UploadFileSerialNumber({ taskId, clientId, setImageSerialNumber, images, setImages, imageFront, imageLogo, imageArmEngravings, imageSerialNumber, imageScrews, imageLensEngraving, imageAdditionalImage }) {
