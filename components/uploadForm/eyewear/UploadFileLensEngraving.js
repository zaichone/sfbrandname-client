...
function UploadFileLensEngraving({ taskId, clientId, setImageLensEngraving, images, setImages, imageFront, imageLogo, imageArmEngravings, imageSerialNumber, imageScrews, imageLensEngraving, imageAdditionalImage }) {
    ...
    return (
        <div className="col-4 text-center mt-4">
            ...
            >
                ...
                <input style={{ display: "none" }} type="file" onChange={uploadFileLensEngraving} id="filesLensEngraving" name="filesAdditionalImage[]" multiple />
            </SymmetricalDiv>
        </div>
    )
}
