...
function UploadFileArmEngravings({ taskId, clientId, setImageArmEngravings,  images, setImages, imageFront, imageLogo, imageArmEngravings, imageSerialNumber, imageScrews, imageLensEngraving, imageAdditionalImage }) {
