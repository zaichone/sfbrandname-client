...
function UploadFileScrews({ taskId, clientId, setImageScrews, images, setImages, imageFront, imageLogo, imageArmEngravings, imageSerialNumber, imageScrews, imageLensEngraving, imageAdditionalImage }) {
