...
function UploadFileAdditionalImage({ taskId, clientId, setImageAdditionalImage, images, setImages, imageFront, imageLogo, imageArmEngravings, imageSerialNumber, imageScrews, imageLensEngraving, imageAdditionalImage }) {
