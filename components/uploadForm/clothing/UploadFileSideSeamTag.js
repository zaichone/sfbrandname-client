...
function UploadFileSideSeamTag({ taskId, clientId, setImageSideSeamTag,  images, setImages, imageFront, imageLogo, imageSideSeamTag, imageButton, imageZipper, imageAdditionalImage }) {
    ...
    return (
        <div className="col-4 text-center mt-4">
            ...
            >
                ...
                <input style={{ display: "none" }} type="file" onChange={uploadFileSideSeamTag} id="filesSideSeamTag" name="filesSideSeamTag[]" multiple />
            </SymmetricalDiv>
        </div>
    )
}
