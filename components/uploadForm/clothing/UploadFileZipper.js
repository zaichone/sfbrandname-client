...
function UploadFileZipper({ taskId, clientId, setImageZipper, images, setImages, imageFront, imageLogo, imageSideSeamTag, imageButton, imageZipper, imageAdditionalImage }) {
    ...
    return (
        <div className="col-4 text-center mt-4">
            ...
            <SymmetricalDiv className="d-flex flex-column align-items-center justify-content-center image-box"
                ...
                style={{ backgroundImage: `url(${imageZipper?.imageURL})` }}
            >
                <i>Click to Add Image</i>
                <input style={{ display: "none" }} type="file" onChange={uploadFileZipper} id="filesZipper" name="filesZipper[]" multiple />
            </SymmetricalDiv>
        </div>
    )
}
