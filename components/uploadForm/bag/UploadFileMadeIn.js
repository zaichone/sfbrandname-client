...
function UploadFileMadeIn({ taskId, clientId, setImageMadeIn,  images, setImages, imageFront, imageLogo, imageMadeIn, imageSerialNumber, imageHardwareEngraving, imageAdditionalImage }) {
    ...
    return (
        <div className="col-4 text-center mt-4">
            ...
            >
                ...
                <input style={{ display: "none" }} type="file" onChange={uploadFileMadeIn} id="filesMadeIn" name="filesMadeIn[]" multiple />
            </SymmetricalDiv>
        </div>
    )
}
