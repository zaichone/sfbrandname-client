...
function UploadFileAdditionalImage({ taskId, clientId, setImageAdditionalImage, images, setImages, imageFront, imageLogo, imageMadeIn, imageSerialNumber, imageHardwareEngraving, imageAdditionalImage }) {
