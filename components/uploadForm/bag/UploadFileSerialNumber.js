...
function UploadFileSerialNumber({ taskId, clientId, setImageSerialNumber, images, setImages, imageFront, imageLogo, imageMadeIn, imageSerialNumber, imageHardwareEngraving, imageAdditionalImage }) {
