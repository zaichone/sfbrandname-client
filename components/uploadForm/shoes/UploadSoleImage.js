...
function UploadSoleImage({taskId, clientId , setImageSole,  images, setImages, imageFront,imageSole,imageMadeIn,imageSerialNumber,imageInsole,imageAdditionalImage}) {
    ...
    return (
        ...
        >
           ...
           <input style={{display:"none"}} type="file" onChange={uploadFileSole} id="filesSole" name="filesSole[]" multiple />
        </SymmetricalDiv>
    </div>
    )
}
