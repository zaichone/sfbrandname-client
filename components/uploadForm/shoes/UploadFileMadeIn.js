...
function UploadFileMadeIn({ taskId, clientId, setImageMadeIn,  images, setImages, imageFront, imageSole, imageMadeIn, imageSerialNumber, imageInsole, imageAdditionalImage }) {
    async function uploadFileMadeIn() {
        ...
        await thisRef.put(file).then(function (snapshot) {
            snapshot.ref.getDownloadURL().then((downloadURL) => {
                ...
                setImages([imageFront, imageSole, imageMadeIn, imageSerialNumber, imageInsole, imageAdditionalImage]);
