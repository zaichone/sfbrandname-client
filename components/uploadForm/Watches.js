    ...
    return (
        <div className="row">
            <UploadFrontImage
                ...
                setFeatured={setFeatured} setImageFront={setImageFront} setImageFace={setImageFace}
                imageFront={imageFront} imageFace={imageFace} imageCaseEngravings={imageCaseEngravings} imageSerialNumber={imageSerialNumber} imageCrown={imageCrown} imageClasp={imageClasp} imageAdditionalImage={imageAdditionalImage} />
            <UploadFaceImage
                taskId={taskId} clientId={clientId} images={images} setImages={setImages}
