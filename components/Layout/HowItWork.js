...
function HowItWork() {
    return (
        <section className="front-how-it-work">
            <div className="container-fluid">
                <div className="row">

                    <div className="col-12 col-sm-12 d-flex flex-column align-items-center">
                    ...
                    <div className="col-12 text-center learn-more"><Link href="#">LEARN MORE</Link></div>
                </div>
